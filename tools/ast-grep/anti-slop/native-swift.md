...
additive. It catches semantic checks that need a type checker. Add this fragment
to `.swiftlint.yml` if SwiftLint is already in the project. Do not add SwiftLint
as a new dependency solely for this pack.
